...
```{r, include = TRUE, message = FALSE, warning = FALSE, cache = FALSE, fig.height = 8, fig.width = 16}
for (i in 1:4){
pdf(paste(Downs.list[[i]]$Donor[i], "_UMAP_celltypeMarkers.pdf", sep = ''), width = 30,30)
...
```{r, include = TRUE, message = FALSE, warning = FALSE, cache = FALSE, fig.height = 8, fig.width = 16}
#DimPlot(Downs.list[[i]], reduction = "umap", group.by = 'Disease')
#DimPlot(Downs.list[[i]], reduction = "umap", group.by = 'Donor')
```
